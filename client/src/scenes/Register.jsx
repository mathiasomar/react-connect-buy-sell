...
const Register = () => {
  ...
  return (
    <Section className="min-h-screen">
      ...
      <Container className="w-full h-full flex items-center justify-center mt-[100px]">
          ...
          <div className="xl:col-span-7 lg:col-span-7 py-[40px] px-[75px] bg-white flex justify-center">
            <form className="w-full" autoComplete="off">
              <div className="grid grid-cols-12 gap-4">
                <div className="lg:col-span-6 md:col-span-12 mb-4">
                  <label
                    htmlFor="fname"
                ...
                <div className="col-span-12 mb-4 flex items-center">
                  <input type="checkbox" name="" id="agree" />
                  <label htmlFor="agree" className="ml-2">I agree with the <a href="/terms" className="text-primary font-semibold">Terms and Conditions</a></label>
                </div>
              </div>
