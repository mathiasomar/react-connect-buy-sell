...
const Membership = () => {
  ...
  useEffect(() => {
    document.title = "Connect | Membership";
    if (isInView) {
  ...
  return (
    <Section className="min-h-screen">
      <Container>
        <PageHeader page="Membership" />
      </Container>

      <Container className="mt-[50px]">
        <h1 className="flex items-center justify-center mb-50 font-[600] text-6xl capitalize text-dark leading-[56px]">
          membership plan
        </h1>
        ...
        <motion.div
          ...
          className="w-full grid grid-cols-12 gap-5 mt-14  "
        >
          {membership.map(
            ({
              id,
